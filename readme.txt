...
= Notice: My Twitter 1.1.6 uses new CSS. So for you who upgrade it, you need to refresh the page (CTRL+F5) in order for the new CSS to take effect =

My Twitter is a WordPress plugin made by Xhanch Studio to show your latest tweets, replies, user's profile picture(or you may just show the name instead of picture), post date(changeable format), click-able links within the tweets, convert smilies syntax to smilies and some custom texts(can be HTML code). You may also choose one of predefined header styles that suits you. My Twitter generates very clean, table-less and valid XHTML codes.
