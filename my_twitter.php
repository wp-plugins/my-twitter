...
<?php		
	...
	function my_twitter_control(){			
		...
		$text_header = get_option('my_twitter_text_header');
		$text_footer = get_option('my_twitter_text_footer');
		...
		if ($_POST['my_twitter_submit']){
			...
			update_option("my_twitter_text_header", htmlspecialchars($_POST['my_twitter_text_header']));
			update_option("my_twitter_text_footer", htmlspecialchars($_POST['my_twitter_text_footer']));
