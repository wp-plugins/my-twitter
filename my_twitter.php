...
?>
		...
		<div id="xhanch_my_twitter">
			...
			<?php if (get_option("my_twitter_credit")){ ?>
				<div class="credit"><a href="http://xhanch.com/wp-plugin-my-twitter/" rel="section" title="My Twitter - A free WordPress plugin to display your latest tweets from Twitter">My Twitter</a>, by <a href="http://xhanch.com/" rel="section" title="Developed by Xhanch Studio">Xhanch</a></div>
			<? }?>
		</div>
<?php		
		echo $after_widget;
