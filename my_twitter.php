		...
		<div id="xhanch_my_twitter">
			...
			<?php if($scroll_mode){ ?>
				<?php if($scroll_animate){ ?>
					<marquee direction="up" onmouseover="this.stop()" onmouseout="this.start()" scrolldelay="<?php echo $scroll_animate_delay; ?>" scrollamount="<?php echo $scroll_animate_amount; ?>" height="<?php echo $scroll_h; ?>px">
				<?php }else{ ?>
