<?php
	...
	*/
	...
	function my_twitter($param, $args = array()){		
		update_option("my_twitter_title", htmlspecialchars($param['my_twitter_title']));
		update_option("my_twitter_name", htmlspecialchars($param['my_twitter_name']));
		update_option("my_twitter_id", htmlspecialchars($param['my_twitter_id']));
		update_option("my_twitter_count", intval($param['my_twitter_count']));
		update_option("my_twitter_show_post_by", htmlspecialchars($param['my_twitter_show_post_by']));
		update_option("my_twitter_date_format", htmlspecialchars($param['my_twitter_date_format']));
		update_option("my_twitter_text_header", htmlspecialchars($param['my_twitter_text_header']));
		update_option("my_twitter_text_footer", htmlspecialchars($param['my_twitter_text_footer']));
		update_option("my_twitter_credit", intval($param['my_twitter_credit']));
